...
CREATE TABLE IF NOT EXISTS item_request (
    ...
    CONSTRAINT fk_request_requestor FOREIGN KEY (requester_id) REFERENCES users(id)
    );
...
CREATE TABLE IF NOT EXISTS item (
    ...
    request_id BIGINT NULL,  -- ← NULL, а не NOT NULL!
    CONSTRAINT pk_item PRIMARY KEY (id),
    CONSTRAINT fk_item_owner FOREIGN KEY (owner_id) REFERENCES users(id),
    CONSTRAINT fk_item_request FOREIGN KEY (request_id) REFERENCES item_request(id)
    );
